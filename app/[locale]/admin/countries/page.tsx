              ...
              {countries.length === 0 ? (
                ...
                countries.map((country) => (
                  <tr key={country.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                    <td className="px-6 py-4 font-medium text-gray-900 dark:text-white">{country.name}</td>
                    <td className="px-6 py-4 text-gray-600 dark:text-gray-400">{country.code}</td>
                    <td className="px-6 py-4 text-gray-600 dark:text-gray-400">{country._count.cities}</td>

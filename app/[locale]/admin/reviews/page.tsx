...
export default function ReviewsPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-serif text-black dark:text-white mb-2">Reviews Management</h1>
        <p className="text-gray-600 dark:text-gray-400">Moderate and manage hotel reviews</p>
      </div>
